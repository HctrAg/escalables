...
export class AppComponent {
  ...
  public shows: Show[] = [
    ...
    constructor(){
      //this.shows.splice(0, 1); /* Para eliminar, uno recorre los elementos por indice, el otro lo filtra */
      //this.shows = this.shows.filter(show => show.name != "Breaking Bad")
    ...
    public editCard(show : Show):void{
      const index = this.shows.findIndex(s => s.name === show.name);
